...
import { FiSave, FiX, FiPlus, FiTrash2, FiUpload, FiRefreshCw, FiImage } from 'react-icons/fi'
...
const CreateProject = () => {
  ...
  // ============================================
  // 🔄 تابع تولید اسلاگ از عنوان انگلیسی
  // ============================================
  ...
  // ============================================
  // 🎯 وقتی عنوان انگلیسی تغییر می‌کند، اسلاگ را آپدیت کن
  // ============================================
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await api.post('/api/admin/projects/', projectData)
